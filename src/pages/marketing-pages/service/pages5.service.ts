...
import { Page5Marketing } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages5MarketingRepository } from '../marketing-pages.repository';
@Injectable()
export class Pages5MarketingService {
  constructor(private readonly pageRepository: Pages5MarketingRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page5Marketing {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
