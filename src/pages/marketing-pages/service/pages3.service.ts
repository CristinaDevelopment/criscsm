...
import { Page3Marketing } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages3MarketingRepository } from '../marketing-pages.repository';
@Injectable()
export class Pages3MarketingService {
  constructor(private readonly pageRepository: Pages3MarketingRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page3Marketing {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
