...
import { Page0Marketing } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages0MarketingRepository } from '../marketing-pages.repository';

@Injectable()
export class Pages0MarketingService {
  constructor(private readonly pageRepository: Pages0MarketingRepository) {}
