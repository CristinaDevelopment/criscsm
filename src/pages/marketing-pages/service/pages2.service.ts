...
import { Page2Marketing } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages2MarketingRepository } from '../marketing-pages.repository';
@Injectable()
export class Pages2MarketingService {
  constructor(private readonly pageRepository: Pages2MarketingRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page2Marketing {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
