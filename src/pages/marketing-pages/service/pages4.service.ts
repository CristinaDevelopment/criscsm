...
import { Page4Marketing } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages4MarketingRepository } from '../marketing-pages.repository';
@Injectable()
export class Pages4MarketingService {
  constructor(private readonly pageRepository: Pages4MarketingRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page4Marketing {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
