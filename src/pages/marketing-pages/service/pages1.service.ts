...
import { Page1Marketing } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages1MarketingRepository } from '../marketing-pages.repository';

@Injectable()
export class Pages1MarketingService {
  constructor(private readonly pageRepository: Pages1MarketingRepository) {}
