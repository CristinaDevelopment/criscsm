...
export const Page0MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page1MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page2MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page3MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page4MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page5MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page6MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page7MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page8MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page9MarketingSchema = SchemaFactory.createForClass(PageDocument);
export const Page10MarketingSchema = SchemaFactory.createForClass(PageDocument);
