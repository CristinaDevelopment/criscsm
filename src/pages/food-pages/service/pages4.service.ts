...
import { Page4Food } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages4FoodRepository } from '../food-pages.repository';
@Injectable()
export class Pages4FoodService {
  constructor(private readonly pageRepository: Pages4FoodRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page4Food {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
