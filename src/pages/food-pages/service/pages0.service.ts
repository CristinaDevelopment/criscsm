...
import { Page0Food } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages0FoodRepository } from '../food-pages.repository';

@Injectable()
export class Pages0FoodService {
  constructor(private readonly pageRepository: Pages0FoodRepository) {}
