...
import { Page6Food } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages6FoodRepository } from '../food-pages.repository';
@Injectable()
export class Pages6FoodService {
  constructor(private readonly pageRepository: Pages6FoodRepository) {}
