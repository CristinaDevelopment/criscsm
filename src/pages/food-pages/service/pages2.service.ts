...
import { Page2Food } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages2FoodRepository } from '../food-pages.repository';
@Injectable()
export class Pages2FoodService {
  constructor(private readonly pageRepository: Pages2FoodRepository) {}
