...
import { Page5Food } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages5FoodRepository } from '../food-pages.repository';
@Injectable()
export class Pages5FoodService {
  constructor(private readonly pageRepository: Pages5FoodRepository) {}
