...
import { Page3Wear } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages3WearRepository } from '../wear-pages.repository';
@Injectable()
export class Pages3WearService {
  constructor(private readonly pageRepository: Pages3WearRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page3Wear {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
