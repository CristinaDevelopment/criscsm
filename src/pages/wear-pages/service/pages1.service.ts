...
import { Page1Wear } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages1WearRepository } from '../wear-pages.repository';

@Injectable()
export class Pages1WearService {
  constructor(private readonly pageRepository: Pages1WearRepository) {}
