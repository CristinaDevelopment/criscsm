...
import { Page6Wear } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages6WearRepository } from '../wear-pages.repository';
@Injectable()
export class Pages6WearService {
  constructor(private readonly pageRepository: Pages6WearRepository) {}
