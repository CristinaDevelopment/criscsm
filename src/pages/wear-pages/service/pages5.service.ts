...
import { Page5Wear } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages5WearRepository } from '../wear-pages.repository';
@Injectable()
export class Pages5WearService {
  constructor(private readonly pageRepository: Pages5WearRepository) {}
  ...
  private toModel({ _id, data, siteId, parentId, slug }: PageDocument): Page5Wear {
    return {
      _id: _id.toHexString(),
      data: data,
      siteId: siteId,
