...
import { Page0Wear } from '../../entities/food-page.model';
import { PageDocument } from '../../entities/food-page.schema';
import { Pages0WearRepository } from '../wear-pages.repository';

@Injectable()
export class Pages0WearService {
  constructor(private readonly pageRepository: Pages0WearRepository) {}
