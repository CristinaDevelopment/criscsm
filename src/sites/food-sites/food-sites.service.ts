...
import { SiteFood } from '../entities/site.model';
import { SiteDocument } from '../entities/site.schema';
import { FoodSitesRepository } from './food-sites.repository';

@Injectable()
export class FoodSitesService {
  constructor(
    // private readonly siteEcommerceRepository: SitesEcommerceRepository,
    private readonly siteRepository: FoodSitesRepository, // private readonly siteEducationRepository: SitesEducationRepository, // private readonly siteMarketingRepository: SitesMarketingRepository,
  ) {}
  ...
  private toModel(siteDocument: SiteDocument): SiteFood {
    return {
