...
export class WearSitesService {
  constructor(
    ...
    private readonly siteRepository: WearSitesRepository, // private readonly siteEducationRepository: SitesEducationRepository, // private readonly siteMarketingRepository: SitesMarketingRepository,
  ) {}
  ...
  private toModel(siteDocument: SiteDocument): SiteWear {
    return {
